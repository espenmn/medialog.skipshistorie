...
brains = app.skipshistorie.portal_catalog(portal_type=["Document", "skip"], sort_on="modified", sort_order='ascending')
brains = app.skipshistorie.portal_catalog(id="ltk00119640300000-fernland")
